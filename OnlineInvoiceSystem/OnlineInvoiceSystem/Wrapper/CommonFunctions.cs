...
namespace OnlineInvoiceSystem.Wrapper
{
    class CommonFunctions
    {
        ...
        {
            string driverPath = @"C:\Users\mohit.agarwal\Documents\DemoProject\OnlineInvoiceSystem\OnlineInvoiceSystem\Drivers";
        ...
        public static void markAsFailed(string message)
        {
            Assert.Fail(message);
        }
    }
